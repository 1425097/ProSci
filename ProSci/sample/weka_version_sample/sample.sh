...
#step 3
#wget -O ~/Downloads/weka-3-8-3.zip https://sourceforge.net/projects/weka/files/weka-3-8/3.8.3/weka-3-8-3.zip/download &&
#wget -O ~/Downloads/weka-3-9-1.zip https://sourceforge.net/projects/weka/files/weka-3-9/3.9.1/weka-3-9-1.zip/download &&
#unzip ~/Downloads/weka-3-8-3.zip -d ~/Downloads
